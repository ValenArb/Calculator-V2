...
const SteelRigidCalc = () => {
  ...
  const calculate = () => {
    ...
    // Diámetros estándar de tuberías de acero (steel rigid)
    const steelRigidSizes = [
      { nominal: 16, internal: 15.8, area: 196.1 },
      { nominal: 20, internal: 20.9, area: 343.3 },
      { nominal: 25, internal: 26.6, area: 555.7 },
      { nominal: 32, internal: 35.1, area: 967.6 },
      { nominal: 40, internal: 41.2, area: 1333.8 },
      { nominal: 50, internal: 52.5, area: 2165.0 },
      { nominal: 63, internal: 62.7, area: 3093.6 },
      { nominal: 75, internal: 77.9, area: 4772.1 },
      { nominal: 90, internal: 90.1, area: 6380.4 },
      { nominal: 110, internal: 110.1, area: 9527.8 },
      { nominal: 125, internal: 124.5, area: 12177.5 },
      { nominal: 160, internal: 154.1, area: 18666.4 },
      { nominal: 200, internal: 192.9, area: 29267.0 },
      { nominal: 250, internal: 242.9, area: 46421.7 }
    ];

    // Encontrar el tamaño mínimo requerido
    const recommendedSize = steelRigidSizes.find(size => size.area >= requiredArea);
    ...
    setResult({
      ...
      recommendedSize: recommendedSize?.nominal || 'Mayor a 250mm',
  ...
  return (
    <div className="p-6">
      <h2 className="text-xl font-semibold mb-6">STEEL RÍGIDO</h2>
          ...
          {result ? (
            <>
              <div className="bg-green-50 p-4 rounded-lg">
                <div className="text-sm text-green-600 font-medium">Tamaño recomendado de tubería de acero rígido</div>
